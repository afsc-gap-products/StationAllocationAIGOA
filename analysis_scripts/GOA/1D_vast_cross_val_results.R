...
##################################################
VAST_dir <- "temp/"
data_df <- read.csv("data/GOA/vast_data/goa_data_geostat.csv")
...
save(list = c("cross_val_results", "pred_jnll"),
     file = "data/GOA/vast_data/prednll_VAST_models.RData")
...
####   Save
##################################################
saveRDS(object = D_gct, file = "data/GOA/vast_data/VAST_fit_D_gct.RDS")
